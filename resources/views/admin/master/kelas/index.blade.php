...
<div class="content-wrapper">
    <div class="content-header row">
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Daftar Kelas
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
            <a href="{{route('kelas.create')}}" type="button"
                            ...
                            <table class="table table-bordered data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$hasil->kelas_id}}</td>
                                        <td>{{$hasil->nama_Kelas}}</td>
                                        <th>NIK/NIP</th>
                                        <td>{{$hasil->tingkat}}</td>
                                        <td>{{$hasil->status_aktif}}</td>

                                        <td>
                                            <form action="{{ route('kelas.destroy',$hasil->id) }}" method="POST">

                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('kelas.edit',$hasil->id) }}">Edit</a>
