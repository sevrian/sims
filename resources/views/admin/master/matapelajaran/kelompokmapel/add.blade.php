      ...
      <div class="card-text">
        <div class="col-12">
          <div class="card" style="height: 419.75px;">
            <div class="card-content">
              <div class="card-body">
                <form class="form form-horizontal" action="{{$setting->simpan}}" method="POST">
                  @csrf
                  @method('POST')
                  <div class="form-body">
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group row">
                          ...
                          <div class="col-md-8">
                            <input type="text" id="first-name"  class="form-control" name="kelompok" placeholder="First Name" value="{{ old('kelompok') }}">
