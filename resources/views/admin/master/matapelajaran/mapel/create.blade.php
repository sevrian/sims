                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Mata PelajaranK</a>
                            </li>
                            <li class="breadcrumb-item active">Tambah Mata Pelajaran
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="content-body">
        ...
        <section id="css-classes" class="card">
            <div class="card-header">
                <h4 class="card-title">Form Mata Pelajaran</h4>
            </div>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <span>Kelompol MataPelajaran</span>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <input type="text"  class="form-control" name="Kelompokmapel_id" placeholder="Kelompok Mata Pelajaran" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <span>Tingkat Sekolah X/XI/XII</span>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <input type="text"  class="form-control" name="tingkat" placeholder="tingkat/kelas" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text"  class="form-control" name="aktif" placeholder="aktif/tidak aktif" >
                                                        </div>
                                                    </div>
                                                </div>
