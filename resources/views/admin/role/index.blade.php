                        ...
                        <div class=" table-responsive">
                            <table class="table table-bordered data-table">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($role as $no => $hasil)
                                    <tr>

                                        <td>{{$role->firstItem()+$no}}</td>
                                        <td>{{$hasil->nama_role}}</td>
                                        <td>{{$hasil->keterangan}}</td>
                                        <td>
                                            <form action="{{ route('role.destroy',$hasil->id) }}" method="POST">

                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('role.edit',$hasil->id) }}">Edit</a>
