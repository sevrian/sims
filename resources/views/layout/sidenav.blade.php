    ...
    <div class="main-menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="feather icon-grid"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    {{-- <li class="{{Request::is(isset($setting->url) ? $setting->url:'kelompok_mapel')?'active':''}}"><a
                        href="{{ url ('kelompok_mapel')}}"><i></i><span class="menu-item" data-i18n="2 columns">Kelompok
                            Pelajaran</a>
            </li> --}}
            <li
                class="{{isset($setting->url) ? ($setting->url=='kelompok_mapel' ? 'active':''):( Request::is('kelompok_mapel')?'active':'')}}">
                <a href="{{ url ('kelompok_mapel')}}"><i></i><span class="menu-item" data-i18n="2 columns">Kelompok
                        Pelajaran</a>
            </li>
            <li
                class="{{isset($setting->url) ? ($setting->url=='mapel' ? 'active':''):( Request::is('mapel')?'active':'')}}">
                <a href="{{ url ('mapel')}}"><i></i><span class="menu-item" data-i18n="Fixed navbar">Mata
                        Pelajaran</span></a>
            </li>
            <li
                class="{{isset($setting->url) ? ($setting->url=='jadwal' ? 'active':''):( Request::is('jadwal_pelajaran')?'active':'')}}">
                <a href="{{ url ('jadwal_pelajaran')}}"><i></i><span class="menu-item"
        ...
        <li class=" nav-item"><a href="#"><i class="feather icon-credit-card"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                <li class="{{ Request::is('keuangan_jenis')?'active':''}}"><a
                        href="{{ url ('keuangan_jenis')}}"><i></i><span class="menu-item" data-i18n="2 columns">Jenis
                            Keuangan</a>
                </li>
        ...
        <li class=" nav-item"><a href="#"><i class="feather icon-file-text"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                ...
                <li class="{{ Request::is('indikastor')?'active':''}}"><a href="{{ url ('indikastor')}}"><i></i><span
                            class="menu-item" data-i18n="Fixed navbar">Indikastor</span></a>
                </li>
                <li class="{{ Request::is('evaluasi')?'active':''}}"><a href="{{ url ('evaluasi')}}"><i></i><span
                            class="menu-item" data-i18n="2 columns">Evaluasi</a>
                </li>
                <li class="{{ Request::is('ketrampilan')?'active':''}}"><a href="{{ url ('ketrampilan')}}"><i></i><span
                            class="menu-item" data-i18n="Fixed navbar">Ketrampilan</span></a>
                </li>
                <li class="{{ Request::is('pengetahuan')?'active':''}}"><a href="{{ url ('pengetahuan')}}"><i></i><span
                            class="menu-item" data-i18n="Fixed navbar">Pengetahuan</span></a>
                </li>
        ...
        <li class=" nav-item"><a href="#"><i class="feather icon-settings"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                <li class="{{ Request::is('profil_sekolah')?'active':''}}"><a
                        href="{{ url ('profil_sekolah')}}"><i></i><span class="menu-item" data-i18n="2 columns">Profil
                            Sekolah</a>
                </li>
                <li class="{{ Request::is('akademik')?'active':''}}"><a href="{{ url ('akademik')}}"><i></i><span
                            class="menu-item" data-i18n="2 columns">Tahun Akademik</a>
                </li>
                <li class="{{ Request::is('catatan')?'active':''}}"><a href="{{ url ('catatan')}}"><i></i><span
                            class="menu-item" data-i18n="Fixed navbar">Catatan</span></a>
                </li>
                <li class="{{ Request::is('role')?'active':''}}"><a href="{{ url ('role')}}"><i></i><span
                            class="menu-item" data-i18n="2 columns">Role</span></a>
                </li>
        ...
        <li class=" nav-item"><a href="#"><i class="feather icon-server"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                <li class="{{ Request::is('agama')?'active':''}}"><a href="{{ url ('agama')}}"><i></i><span
                            class="menu-item" data-i18n="2 columns">Agama</a>
                </li>
                <li class="{{ Request::is('negara')?'active':''}}"><a href="{{ url ('negara')}}"><i></i><span
                            class="menu-item" data-i18n="Fixed navbar">Kewarganegraan</span></a>
                </li>
                <li class="{{ Request::is('jenis_ptk')?'active':''}}"><a href="{{ url ('jenis_ptk')}}"><i></i><span
                            class="menu-item" data-i18n="2 columns">Jenis PTK</a>
                </li>
        ...
        <li class=" nav-item"><a href="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/documentation"><i
